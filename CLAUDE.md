...
## Current version: 0.2 (dev branch ahead of main)
- main branch = stable v0.2
- dev branch  = latest work (post v0.2, not yet tagged)
...
└── js/
    ...
    ├── game.js         — core game logic, grid rendering, cell interaction, confetti
    ├── map.js          — level map screen with pagination
    ├── player.js       — profile/inventory screen + bottom-sheet pickers
    ├── shop.js         — two shop screens, item definitions, all critter SVGs
